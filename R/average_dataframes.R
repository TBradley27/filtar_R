...
#' Get the average abundance per records for multiple salmon runs

#' @param df A merged salmon dataframe in which each record represent one locus on a give chromosome, and columns represent coverage values from different read quasi-mapping analyses
#' @return df A bedgraph dataframe with the artihmetic mean average coverage for each records locus
#' @export
